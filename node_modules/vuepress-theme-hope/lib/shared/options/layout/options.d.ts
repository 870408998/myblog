...
export declare type HopeThemeSidebarInfo = HopeThemeSidebarFileInfo | HopeThemeSidebarDirInfo;
export declare type HopeThemeSidebarSorterKeyWord = "readme" | "order" | "date" | "date-desc" | "filename" | "file-number" | "file-number-desc" | "title" | "title-number" | "title-number-desc";
export declare type HopeThemeSidebarSorterFunction = (infoA: HopeThemeSidebarInfo, infoB: HopeThemeSidebarInfo) => number;
export declare type HopeThemeSidebarSorter = HopeThemeSidebarSorterFunction | HopeThemeSidebarSorterKeyWord | HopeThemeSidebarSorterKeyWord[];
...
export declare type HopeThemeLayoutLocaleConfig = HopeThemeLayoutLocaleOptions;
