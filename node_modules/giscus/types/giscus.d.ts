...
declare type InputPosition = 'top' | 'bottom';
declare type Repo = `${string}/${string}`;
declare type Mapping = 'url' | 'title' | 'og:title' | 'specific' | 'number' | 'pathname';
declare type GenericString = string & Record<never, never>;
declare type Theme = 'light' | 'light_high_contrast' | 'light_protanopia' | 'light_tritanopia' | 'dark' | 'dark_high_contrast' | 'dark_protanopia' | 'dark_tritanopia' | 'dark_dimmed' | 'transparent_dark' | 'preferred_color_scheme' | `https://${string}` | GenericString;
declare type Lang = 'de' | 'gsw' | 'en' | 'es' | 'fr' | 'id' | 'it' | 'ja' | 'ko' | 'nl' | 'pl' | 'pt' | 'ro' | 'ru' | 'tr' | 'vi' | 'zh-CN' | 'zh-TW' | GenericString;
declare type Loading = 'lazy' | 'eager';
export {};
