...
`)},k=(e={},a=!1)=>n=>{a&&$(e),n.env.isDebug&&m.info(`Options: ${e.toString()}`);const{base:t,shouldPrefetch:o=!0}=n.options;e.appendBase&&H(t,e),o===!0&&m.warn('The plugin will register service worker to handle assets, so we recommend you to set "shouldPrefetch: false" in VuePress config file.');const p=A(n,e);return n.options.head=L(e,t,n.options.head),I(n,{id:"hope"}),{name:"vuepress-plugin-pwa2",define:()=>({PWA_LOCALES:x({app:n,name:"pwa",default:w,config:e.locales}),SW_FORCE_UPDATE:e.update==="force",SW_PATH:e.swPath||"service-worker.js"}),extendsBundlerOptions:(i,s)=>{C({app:s,config:i},["mitt","register-service-worker"]),j(i,s,"/manifest.webmanifest",async()=>JSON.stringify(await p),"Unexpected manifest generate error")},onGenerated:async i=>{await W(i,p),await D(i,e)},clientConfigFile:i=>E(i,e)}};export{k as default,w as pwaLocales,k as pwaPlugin};
