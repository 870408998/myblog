...
1. 在 <code>test</code> 数据库中，新建 <code>ev_users</code> 表如下：
   <!-- ![用户表图片](/src/.vuepress/public/assets/img/guide/ev_users.png) -->
...
### 4.1 新建 ev_article_cate 表
   ...
   <!-- ![文章图片](/src/.vuepress/public/assets/img/guide/ev_article_cate.png) -->
...
### 5.1 新建 ev_articles 表
   ...
   <!-- ![文章图片](/src/.vuepress/public/assets/img/guide/ev_articles.png) -->
